...
import "./Register.css"
import {cpfMask} from "../../constants/utils/maks";
...
const Register: React.FC<IRegister> = ({onHandleAction}) => {
  ...
  return (
    <form className="formRegister">
      ...
      <input type={email} value={cell} placeholder="Telefone" onChange={(e) => setCell(e.target.value)}/>
      <input value={birthDate} placeholder="Data de Nascimento" onChange={(e) => setBirthDate(e.target.value)}/>
      ...
      <input value={license} placeholder="Placa" onChange={(e) => setLicense(e.target.value)}/>
